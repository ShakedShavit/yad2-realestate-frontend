...
function HomePage() {
    ...
    useEffect(() => {
        if (!isLoginModalOpen && isSignupSecondPage)
            setIsSignupSecondPage(false);
    ...
    return (
        <>
            <div
                className={
                    isLoginModalOpen ? "home-page no-scroll" : "home-page"
                }
                ref={homePageRef}
