...
function ApartmentWrapper({ details, files }) {
  ...
  useEffect(() => {
    ...
    for (let file of files) {
      if (file.FileKey.includes("video")) continue;
      setDisplayFile(file);
      break;
    }
  }, [files]);
            ...
            <div className="details-wrapper-closed">
              <div className="info-rows">
                ...
                <span className="desktop-local-headline">
                  {(details.location.streetName || details.location.town) +
                    " " +
                ...
                {isExpanded && (
                  <div className="phone-num-btn">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        setIsPhoneNumDropdownOpen(!isPhoneNumDropdownOpen);
                      }}
                    >
                    ...
                    {isPhoneNumDropdownOpen && (
                      <PhoneNumDropdown publishers={details.publishers} />
                    )}
                  </div>
                )}
              </div>
