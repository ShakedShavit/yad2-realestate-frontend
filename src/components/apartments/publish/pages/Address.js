...
function Address(props) {
    ...
    const [apartmentConditionErrMsg, setApartmentConditionErrMsg] =
        useState("");
    ...
    const validateFormOnClick = () => {
        ...
        if (isFormValid)
            props.setFinishedInfo(
                `${apartmentType} - ${chosenCity}` +
                    (!!chosenStreet ? ` - ${chosenStreet}` : "")
            );
        else props.setFinishedInfo("");

        return {
            isFormValid,
            newProperties: isFormValid
                ? {
                      town: chosenCity,
                      ...
                      type: apartmentTypesEn[
                          apartmentTypesHebrew.indexOf(apartmentType)
                      ],
                      condition:
                          apartmentConditionEn[
                              apartmentConditionsHebrew.indexOf(
                                  apartmentCondition
                              )
                          ],
                  }
            ...
            {props.isCurrPage && (
                <div className="publish-page-content publish-address-page">
                    ...
                    <form className="form-body address-form">
                        ...
                        <PublishInputErrMsg
                            errMsg={apartmentTypeErrMsg}
                            setErrMsg={setApartmentTypeErrMsg}
                            inputValue={apartmentType}
                        />
                        ...
                        <select
                            onChange={(e) => {
                                setApartmentCondition(e.target.value);
                            }}
                        >
                            {[
                                "משופץ? חדש מקבלן?",
                                ...apartmentConditionsHebrew,
                            ].map((conditionStr, index) => {
                                return (
                                    <SelectOption
                                        value={conditionStr}
                                        isDefaultValue={index === 0}
                        ...
                        <PublishInputErrMsg
                            errMsg={apartmentConditionErrMsg}
                            setErrMsg={setApartmentConditionErrMsg}
                            inputValue={apartmentCondition}
                        />
                        ...
                        <PublishInputErrMsg
                            errMsg={cityErrMsg}
                            setErrMsg={setCityErrMsg}
                            inputValue={chosenCity}
                        />

                        <label>
                            רחוב{allStreetsListState.length > 0 && <b>*</b>}
                        </label>
                        <AutoCompleteInput
                        ...
                        />
                        <span className="street-input-disclaimer">
                            המידע הזה מגיע מגוף ממשלתי, אם הרחוב שלך לא מופיע,
                            מומלץ לבחור רחוב קרוב אליך
                        </span>
                        <br></br>
                        <PublishInputErrMsg
                            errMsg={streetErrMsg}
                            setErrMsg={setStreetErrMsg}
                            inputValue={chosenStreet}
                        />
                        ...
                        />
                        <PublishInputErrMsg
                            errMsg={houseNumErrMsg}
                            setErrMsg={setHouseNumErrMsg}
                            inputValue={houseNum}
                        />
                        ...
                        <div className="desktop-fields-wrapper">
                            <div className="building-details-container">
                                ...
                                />
                                <PublishInputErrMsg
                                    errMsg={floorNumErrMsg}
                                    setErrMsg={setFloorNumErrMsg}
                                    inputValue={floorNum}
                                />
                                {floorNumErrMsg.length === 0 && <div></div>}
                                <PublishInputErrMsg
                                    errMsg={maxFloorsErrMsg}
                                    setErrMsg={setMaxFloorsErrMsg}
                                    inputValue={maxFloors}
                                />
                            </div>
